...
print(a-b) # {0,6,8} --- Me da las diferencias de dos conjuntos (Valores que estan en uno quitando los que ya están en otro)
...
miTexto.lower() # "hola, este es mi texto" --- Convierte en minúsculas todo el texto
miTexto.upper() # "HOLA, ESTE ES MI TEXTO" --- convierte en mayúsculas todo el texto
...
miTexto.split(",") #["hola"," este es mi textO"] --- Se convierte en una lista y cada elemento se separa por el parámetro puesto
